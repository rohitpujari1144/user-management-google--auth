    ...
    <>
      <div className="">
        <div className="d-flex ms-3 mt-3" >
          ...
          <button className="btn btn-outline-warning ms-3 mb-2 btn-sm" onClick={() => navigate('/login')}>Log out</button>
        </div>
        <div className="border rounded position-relative top-0 start-50 translate-middle-x mt-5" style={{ width: '65%', height: '420px', overflow: 'auto' }}>
