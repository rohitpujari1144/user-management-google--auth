...
function AdminSignIn() {
  ...
  return (
    <>
      <div className='position-absolute top-50 start-50 translate-middle border border-primary p-3 rounded' style={{}}>
        <h4 className="tetx-center" style={{ fontFamily: 'Arial' }}>Login as Admin</h4>
