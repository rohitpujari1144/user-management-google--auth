...
function Registration() {
  ...
  const userD = JSON.parse(localStorage.getItem('userLoginData'))
  // console.log(userD);
      ...
      fetch(`https://react-google-login-be.onrender.com/updateUser/${userD.email}`, {
        ...
        .then((data) => {
          ...
          fetch('https://react-google-login-be.onrender.com')
            .then((res) => res.json())
            .then((newData) => {
              let uData = newData.filter((elem) => elem.email === userD.email)
              // console.log(uData);
                ...
                <div className=" mt-2 mx-4 d-flex flex-column justify-content-center ">
                  ...
                  <div>
                    <div className="row">
                      ...
                      <div className="">
                        <Form.Control id='userName' type="text" defaultValue={userD.name} autoComplete='off' onKeyUp={() => { nameValidate() }} />
                    ...
                    <div className="row">
                      ...
                      <div className="">
                        <Form.Control id='ageInput' type="text" defaultValue={userD.age} autoComplete='off' onKeyUp={() => { ageValidate() }} />
                    ...
                    <div className="row">
                      ...
                      <div className="">
                        <Form.Control id='userAddress' type="text" defaultValue={userD.address} autoComplete='off' />
                    ...
                    <div className="row">
                      ...
                      <div className="">
                        <Form.Control id='userSocial' type="text" defaultValue={userD.socialMediaHandle} autoComplete='off' />
